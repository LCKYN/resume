...
\newcommand\locationEdu{Bangkok, TH}
\newcommand\fieldEdu{Bachelor of Engineering (Computer)}
\newcommand\dateEdu{Aug. 2015 -- Apr. 2019}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\fieldEdu}{\locationEdu}
      {Master of Science in Computer Science;  GPA: 4.00}{\dateEdu}
    \resumeSubheading
